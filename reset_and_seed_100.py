...
with app.app_context():
    print("=" * 60)
    print("RESETTING ACHIEVEMENTS TO 100")
    print("=" * 60)
    
    # Step 1: Clear existing data
    print("\n1. Clearing existing achievements...")
    try:
    ...
    # Step 2: Load and seed new achievements
    print("\n2. Loading achievements from JSON...")
    json_path = os.path.join('data', 'seed', 'achievements_seed_complete.json')
    
    if not os.path.exists(json_path):
        print(f"   ✗ Error: {json_path} not found!")
        print("   Creating file with 100 achievements...")
        ...
        achievements_data = {
            "achievements": [
                ...
                {"name": "Top Performer", "description": "Average score of 90% or higher", "icon": "fas fa-chart-simple", "points": 40, "category": "quiz", "requirement_type": "high_score", "requirement_value": 90, "badge_color": "blue", "display_order": 12},
    ...
    # Step 3: Load and insert achievements
    print("\n3. Loading achievements from JSON...")
    with open(json_path, 'r', encoding='utf-8') as f:
        data = json.load(f)
    
    achievements = data.get('achievements', [])
    print(f"   Found {len(achievements)} achievements in JSON")
    
    # Step 4: Insert achievements
    print("\n4. Inserting achievements into database...")
    for ach in achievements:
        achievement = Achievement(
            ...
            requirement_extra=ach.get('requirement_extra'),
    ...
    if final_count == 100:
        print("\n✅ SUCCESS! 100 achievements have been seeded!")
    else:
        print(f"\n⚠ Warning: Expected 100, got {final_count}")
    
    # Show category breakdown
    print("\n   Category breakdown:")
    categories = db.session.query(Achievement.category, db.func.count()).group_by(Achievement.category).all()
    for cat, count in categories:
        print(f"     - {cat}: {count}")

print("\n" + "=" * 60)
print("Run: python run.py")
print("Then refresh your achievements page!")